...
public class ContactList_Vendor {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		for (int i = 0; i < 5; i++) {
			...
			for (int j = 0; j < 20; j++) {
				...
				create.click();
				Thread.sleep(3000);
				driver.findElement(By.xpath("(//p[@class=\"font16 font_weight_500 font_medium\"])[6]")).click();
				// Basic Details //
				Thread.sleep(3000);
...
//			driver.findElement(By.xpath("(//input[@name=\"upi\"])[1]")).sendKeys(upi_id);
			...
			System.out.println("Vendor Contact Added Successfully");
		}
	}
