...
public class BulkUpload_Customer {
	...
	public static void main(String[] args) throws InterruptedException, AWTException {
		...
		for (int i = 0; i < 20; i++) {
			...
			Thread.sleep(3000);
			driver.findElement(
					By.xpath("(//div[@class=\"bulkUpload__dragFile__boxinner__sc dragattach__file__sc\"])[1]")).click(); // Upload
																															// //
			// Excel Sheet Upload //
			String file = "C:\\Users\\Kunal Chandrakant\\Downloads\\Testted Appplication\\Wegofin\\Wegofin AI\\Wegoai contact module\\Bulk_Upload_Customer.xlsx";
			...
			driver.findElement(By.xpath(
					...
					.click();
//			driver.findElement(By.xpath("//button[@class=\"bulkUpload__popup__submit__btn__sc bulkUpload__popup__submit__btn_contact__ba d__flex__btn font16 font_weight_500 font_white\"]")).click();
